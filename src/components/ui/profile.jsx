  ...
  <div className=" relative overflow-hidden rounded-xl p-2 ">
    <div className="flex items-center gap-4">
      <img
        ...
        className="w-15  h-15 object-center object-cover rounded-full transition-all duration-500 delay-500 transform"
      />
      <div className="w-fit">
        <h1 className=" font-semibold">
          Mary Phiri
        </h1>
        <a className="text-xs  transform transition-all delay-300 duration-500">
          mary@gmail.com
        </a>
      </div>
    </div>
    <div className="absolute  delay-300 -bottom-16 transition-all duration-500   right-1 rounded-lg">
