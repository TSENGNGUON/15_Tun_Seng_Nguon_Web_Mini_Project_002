...
import { UpdateWorkSpaceAction } from "../../../actions/updateWorkSpace-actions";


export  default  function UdateForm({isOpen,setIsOpen,workspace,workspaceId}){
  ...
  return (
    <>
    <form action={UpdateWorkSpaceAction} className={`fixed z-10 inset-0 overflow-y-auto ${isOpen? "hidden":"visibility"}`}>
